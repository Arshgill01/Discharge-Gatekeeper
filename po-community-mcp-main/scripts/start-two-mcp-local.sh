...
REQUESTED_CLINICAL_INTELLIGENCE_REQUIRE_PATIENT_SCOPE="${CLINICAL_INTELLIGENCE_REQUIRE_PATIENT_SCOPE:-}"
...
if [[ -n "${REQUESTED_CLINICAL_INTELLIGENCE_REQUIRE_PATIENT_SCOPE}" ]]; then
  CLINICAL_INTELLIGENCE_REQUIRE_PATIENT_SCOPE="${REQUESTED_CLINICAL_INTELLIGENCE_REQUIRE_PATIENT_SCOPE}"
fi
...
start_server \
  ...
  CLINICAL_INTELLIGENCE_REQUIRE_PATIENT_SCOPE="${CLINICAL_INTELLIGENCE_REQUIRE_PATIENT_SCOPE:-0}" \
