...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FALLBACK-P1-01 | `Is this patient safe to discharge today?` | `https://app.promptopinion.ai/workspaces/019da8ef-cb09-71b0-9d7e-4e11591d55db/conversations/019dda78-95a2-7e9c-82ee-40ea9da5d057` | `assess_discharge_readiness` | yes | yes | no | `yellow` | settle=timeout; anchors=fail; route=Prompt Opinion -> both MCPs |
