...
- Browser session window: `2026-04-25T18:40:44.193Z`
...
| Current blocker-isolation conclusion | `red` | A2A: `chat_path_not_routed`; fallback: `workspace_agent_not_found` |

## Request-id conclusion
- A2A runtime hit proven: no
- If not proven, narrowest blocker: `chat_path_not_routed`
- Direct-MCP fallback blocker: `workspace_agent_not_found`
