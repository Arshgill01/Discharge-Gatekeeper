...
| Run folder | `output/prompt-opinion-e2e/runs/20260425T183357Z` |
...
| Prompt Opinion Direct-MCP fallback workspace lane | RED | Blocker: workspace_agent_not_found. |
...
| Call | NO-GO |
| --- | --- |
| Basis | A2A-main=red; Direct-MCP fallback=red; A2A blocker=chat_path_not_routed; fallback blocker=workspace_agent_not_found |
