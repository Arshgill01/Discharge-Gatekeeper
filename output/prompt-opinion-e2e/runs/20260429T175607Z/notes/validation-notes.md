...
- Browser session window: `2026-04-29T18:09:18.752Z`
...
| Current blocker-isolation conclusion | `red` | A2A: `workspace_ui_unreachable`; fallback: `runtime_hit_but_downstream_failure` |
