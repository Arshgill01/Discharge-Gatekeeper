...
- Browser session window: `2026-04-25T18:56:28.839Z`
...
| Current blocker-isolation conclusion | `red` | A2A: `chat_path_not_routed`; fallback: `runtime_hit_but_downstream_failure` |
